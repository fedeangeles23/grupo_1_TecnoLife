...
function TarjetasCelulares({id, nombre, precio, descripcion, imagenes}) {
    return (
...
TarjetasCelulares.defaultProps = {
    id: 0,
...
export default TarjetasCelulares